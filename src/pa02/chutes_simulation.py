...
class Player:
    ...
    def move(self):
        """
        The move() method moves the player by implementing a dice roll,
...
class Simulation:
    ...
    def __init__(self, player_field, board=Board(), seed=None,
    ...
    def single_game(self):
        ...
        :return: num_moves and type of player
        """
        num_moves = 0
    ...
    def winners_per_type(self):
        """
        Returns a dictionary which maps out player types to the number of wins.
    ...
    def durations_per_type(self):
        """
        Returns a dictionary which maps out player types to lists of game
        duration for that specific type.
    ...
    def players_per_type(self):
        """
        Returns a dictionary which shows how many players of each type
        participate.
